            ...
            String picNameText, String allModifications)
    {
        ...
        try
        {
            ...
            stmt = conn.prepareStatement(
                    "INSERT into User(uName,uImage,userGivenName,allModifications) values(?,?,?,?)");

            stmt.setString(1, userName);
            stmt.setString(2, picText);
            stmt.setString(3, picNameText);
            stmt.setString(4, allModifications);
